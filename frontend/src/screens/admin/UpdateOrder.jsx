                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="col-span-1 bg-gray-50 shadow p-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {order?.orderStatus !== "Delivered" && order?.orderStatus !== "Cancelled" && <button disabled={loading ? true : false} onClick={handleProcessOrder} type="submit" className="active:scale-95 rounded text-sm py-1 px-4 font-semibold bg-red-700 text-white hover:bg-red-800 duration-150 ease-in-out">
                            ...
                            <div className="col-span-1 bg-gray-50 shadow p-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    {order?.paymentInfo?.status === "Not Paid" && <button disabled={loading ? true : false}  type="submit" className="rounded text-sm py-1 px-4 font-semibold bg-red-700 text-white hover:bg-red-800 duration-150 ease-in-out">
