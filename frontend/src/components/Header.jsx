        ...
        <div className="z-20 w-full bg-gray-50 text-gray-900 sticky top-0 left-0 shadow-md">
            <div className="sm:h-[10vh] h-[8vh] max-w-[1200px] m-auto flex items-center justify-between">
                ...
                <div className="flex items-center justify-center">
                    {!user && <Link to={"/login"} className="mx-4 cursor-pointer border border-red-700 rounded shadow text-red-700 px-4 py-1 hover:bg-red-700 hover:text-white transition duration-300">Login</Link>}
